export const PRESET_RPC_NODES = [
  { label: "Pub1", url: "https://pub1.aplocoin.com" },
  { label: "Pub2", url: "https://pub2.aplocoin.com" },
  { label: "Custom", url: "" },
];

export const CONTRACT_ADDRESS = "0x0000000000000000000000000000000000001234";
export const APLO_STAKING_ADDRESS = "0x0000000000000000000000000000000000001235";
...
export const DEFAULT_DIFFICULTY = BigInt(
